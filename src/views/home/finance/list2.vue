<template>
  <div class="myTable">
    ...
    <el-table :data="financeList" border height="580" style="width: 100%">
      ...
      <el-table-column label="运单总价" prop="sum" width="200" align="center">
      </el-table-column>
      <el-table-column
        label="赔付金额"
        prop="compensate"
...
export default {
  ...
  methods: {
    ...
    findPages(current, limit) {
      this.$http({
        method: "get",
        url: `finance/unvalue/${current}/${limit}`,
        data: this.finance,
      }).then((res) => {
